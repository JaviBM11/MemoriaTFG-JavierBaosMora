...
de }\emph{\large{}alterting}{\large{}. Cubrir esta carencia y ayudar
a la implantación de dicha solución global era mi acometido.}{\large\par}
...
y, en consecuencia, sus redes. Por tanto, nos encontramos con una
red heterogénea, multitud de equipos y }\emph{\large{}vendors}{\large{}
...
monitoriza de forma diferente y con un elemento distinto. Esto dificulta
...
servicio. Y cuando se identifique una degradación, se generarán alertas
...
for time series analytics'' dan indicios sobre su filosofía.}{\large\par}
...
{\large{}{}En esta sección se introduce la esctura de la memoria:}{\large\par}
...
{\large{} }{\large\par}
\item {\large{}{}En el capítulo~\ref{chap:objetivos} se muestra los objetivo
...
{\large{} }{\large\par}
\item {\large{}{}Diseñare gráficamente la aplicación. Decidir el diseño
...
Orange cuenta con una media de edad alta en la plantilla poco habituada
a utilizar este tipo de aplicativos, entra un proceso de cambio cultural.}{\large\par}
...
cronología dividida en semanas, compajinando trabajo y proyecto han
sido necesarios fines de semana para entregarlo a tiempo:}{\large\par}
...
por funcionalidad, elasticsearch no está enfocado a análisis de time-series
...
permitirá configurar alarmas sobre las métricas, crear templates para
agilizar aún más la definición de alarmas, listar las alarmas configuradas,
...
{\large{}{}Por detrás, se aplica una lógica de chequeo de estados
...
crontab de la máquina para hacer backup diarios a las 00:00 de la
base de datos MySQL, de los archivos de configuración de los aplicativos
Graphite y Grafana y del repositorio de scripts python.}{\large\par}
...
y se ha realizado un continuo proceso de ``fine tunning'' de los
aplicativos debido al incremento notable de métricas configuradas,
...
base consta de una barra de navegación horizontal (navbar) con la
versión actual de software, el acceso a la administración de la web
y un acceso a la ayuda; un panel de navegación a la izquierda (side-menu)
en la que se muestra el acceso al dashboard, añadir métrica/alarma,
metricas configuradas, templates, configurar alarmas, historial de
alarmas y ajustes; y una zona central con el contenido dependiendo
de la selección del menú.}{\large\par}
...
{\large{}{}En la página principal se muestra un ``Dashboard'' distribuido
como se ve en la imagen adjuntada a continuación. La parte superior
es un resumen de las métricas configuradas (cuadrado verde), las alarmas
warning (cuadrado azul), major (cuadrado amarillo) y criticas (cuadrado
rojo). La parte inferior muestra un listado de las alarmas activas
caracterizadas por: dashboard de grafana, nombre de la métrica, ultimo
valor, estado (warning, major o critical) y la hora y fecha de inicio
de la alarma. Finalmente, en el centro se mostrara la gráfica de la
alarma que se seleccione o en su defecto la primera alarma, en el
caso de no existir alarma como sucede en este caso, se muestra un
error 404.}{\large\par}
...
\begin{enumerate}
\item {\large{}{}Arquitectura de Internet: en ella recibió la formación
básica en arquitecturas de protocolos en redes de ordenadores, centrádose
...
impartia ninguno de los lenguajes utilizados en el proyecto, sí se
...
aquí se aprendieron los principales elementos del proyecto, el lenguaje
de programación Python y el framework Django.}{\large\par}
...
los refuerza y completa. En sus contenidos se incluye el estudio de

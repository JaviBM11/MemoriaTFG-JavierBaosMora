...
\par \Large GRADO EN INGENIERIA DE SISTEMAS AUDIOVISUALES Y MULTIME\par \vspace{0.4cm}
...
{\large{}de 20XX, siendo calificada por el siguiente tribunal:}{\large\par}
...
{\large{}En esta memoria se presenta una solución de mantenimiento
...
a cualquier capa de red y probada en la realidad.}{\large\par}
...
de diferentes vendors. Estas eran cerradas, con poca escalabilidad
...
Graphite y Grafana con una carencia, la capa de alerting. Cubrir esta
...
y por consecuencia sus redes. Es una red heterogénea, multitud de
equipos y vendors con sus diferentes elementos de gestión y monitorización.}{\large\par}
...
el troubleshooting entre capas, una visión E2E (End to End) de servicio
e incluso los postmorten de las incidencias.}{\large\par}

{\large{}Conseguir unificar y centralizar toda la información permitirá
correlar alarmas de diversas capas de red sacando KPIs de servicio.
Los cuales, cuando notemos una degradación, generarán alertas preventivas.}{\large\par}
...
\item {\large{}Lógica de la herramienta. Acotar la funcionalidades de la
herramienta, tener claro el para, el que y el cómo.}{\large\par}
\item {\large{}Diseño gráfico del aplicativo. Decidir el diseño gráfico
buscando siempre una aplicación sencilla, rápida e intuitiva.}{\large\par}
\item {\large{}Puesta en marcha. Transferir a mantenimiento, procedimientos
...
{\large{}Es una herramienta de monitorización válida tanto para infraestructuras
...
{\large{}Consiste en tres componentes software:}{\large\par}
\begin{itemize}
...
{\large{}Es un framework de aplicaciones web gratuito y de código
...
otra plataforma formada por 3 servidores DELL PowerEdge R630.}{\large\par}
...
{\large{}}
\begin{figure}
{\large{}\centering \includegraphics[width=9cm]{img/img18-DiagramaLogica}
\caption{Diagrama Logico}
...
{\large{}}
\begin{figure}
{\large{}\centering \includegraphics[width=9cm]{img/img19-urls}
\caption{urls.py}
\label{fig:urls.py}}
\end{figure}
{\large\par}
...
{\large{}}
\begin{figure}
{\large{}\centering \includegraphics[width=9cm]{img/img20-dashboard}
\caption{Dashboard}
\label{fig:dashboard}}
\end{figure}
{\large\par}
...
{\large{}}
\begin{figure}
{\large{}\centering \includegraphics[width=9cm]{img/img21-NuevaMetricaSeleccionDash}
\caption{Seleccion Dashboard}
...
{\large{}}
\begin{figure}
{\large{}\centering \includegraphics[width=9cm]{img/img22-NuevaMetricaSeleccionPanel}
...
{\large{}}
\begin{figure}
{\large{}\centering \includegraphics[width=9cm]{img/img23-NuevaMetricaSeleccionMetrica}
...
{\large{}}
\begin{figure}
{\large{}\centering \includegraphics[width=9cm]{img/img24-NuevaMetricaComboUmbrales}
...
{\large{}}
\begin{figure}
{\large{}\centering \includegraphics[width=9cm]{img/img25-ListadoMetricas}
...
{\large{}}
\begin{figure}
{\large{}\centering \includegraphics[width=9cm]{img/img26-Templates}
...
{\large{}}
\begin{figure}
{\large{}\centering \includegraphics[width=9cm]{img/img27-TemplatesCombo}
...
{\large{}}
\begin{figure}
{\large{}\centering \includegraphics[width=9cm]{img/img28-ConfigurarAlarmas}
...
{\large{}}
\begin{figure}
{\large{}\centering \includegraphics[width=9cm]{img/img29-HistoricoAlarmas}
...
{\large{}}
\begin{figure}
{\large{}\centering \includegraphics[width=9cm]{img/img31-Forms}
\caption{forms.py}
\label{fig:Forms}}
\end{figure}
{\large\par}
...
{\large{}}
\begin{figure}
{\large{}\centering \includegraphics[width=9cm]{img/img32-Cronologia}
\caption{Cronologia}
...
{\large{}}
\begin{figure}
{\large{}\centering \includegraphics[width=9cm]{img/img33-DevOps}
...
\appendix
{\large{}%dummy comment inserted by tex2lyx to ensure that this paragraph is not empty}{\large\par}
